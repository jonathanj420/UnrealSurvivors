...
#include "DESkill_ShadyDoppel2.h"
#include "DEBehavior_FireProjectile.h"
#include "DEGameplayLibrary.h"

UDESkill_ShadyDoppel2::UDESkill_ShadyDoppel2()
{
    // 1. 경로 설정 (블루프린트 에셋 우클릭 -> '레퍼런스 복사' 후 _C를 꼭 붙여주세요)
    static ConstructorHelpers::FClassFinder<AActor> ProjectileBP(TEXT("/Game/DarkEden/Blueprint/SkillProjectiles/BP_DEProjectile_ShadyDoppel2.BP_DEProjectile_ShadyDoppel2_C"));
...
void UDESkill_ShadyDoppel2::InitBehaviors()
{
    Super::InitBehaviors();
...
void UDESkill_ShadyDoppel2::ExecuteWithContext(FDESkillContext& Context)
{
