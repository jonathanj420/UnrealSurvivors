...
ADEProjectile_DiabloInferno::ADEProjectile_DiabloInferno()
{
	Penetration = -1;
	...
	static ConstructorHelpers::FObjectFinder<UNiagaraSystem> NS_Fire(TEXT("/Game/DarkEden/Data/Niagara/NS_DiabloInferno.NS_DiabloInferno"));
