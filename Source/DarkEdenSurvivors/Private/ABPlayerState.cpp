...
int32 AABPlayerState::GetFameScore() const
{
	return Fame;

}

int32 AABPlayerState::GetGameHighFame()
{
	return GameHighFame;
}
...
{
	//SetPlayerName(TEXT("Destiny"));//nickname
	//SetCharacterLevel(5);
	...
	Fame = ABSaveGame->Fame;
	GameHighFame= ABSaveGame->HighFame;
	Exp = ABSaveGame->Exp;
...
void AABPlayerState::SavePlayerData()
{
	...
	NewPlayerData->Fame = Fame;
	NewPlayerData->HighFame= GameHighFame;
